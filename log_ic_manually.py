...
sys.stdout.write("Testing: " + random_pick + " ")
...
# print("[0]ts. [1]O:0|1. [2]Note.")
print("Last log entry:", ts_to_txt(db_result[0]), "UTC.", "Online." if db_result[1] == 0 else "Offline.", "Note: %s" %(db_result[2]))
